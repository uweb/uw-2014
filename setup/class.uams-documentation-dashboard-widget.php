...
class UAMS_Documentation_Dashboard_Widget
{
    ...
    function uams_add_documentation_dashboard_widget() {

        global $wp_meta_boxes;

        wp_add_dashboard_widget('uams-documentation-dashboard-widget', 'Documentation and FAQs', array($this, 'uams_documentation_html'));

        $wp_meta_boxes['dashboard']['side']['core']['uams-documentation'] =
        $wp_meta_boxes['dashboard']['normal']['core']['uams-documentation'];
        unset($wp_meta_boxes['dashboard']['normal']['core']['uams-documentation']);
    ...
    function uams_documentation_html()
    {
      ?>
